...
<>
    <div className="flex flex-col lg:flex-row">
      ...
      <div className="w-6/6 lg:w-2/6 flex flex-row flex-wrap gap-2 justify-center order-first lg:order-none mb-5">
        {proficiencies.map((prof, index)=>(
            <Proficiency prof={prof} key={index} />
        ))}
        </div>
    <div className="mt-10 mx-5 text-center lg:text-left">
        <p> Here's a small list of things I'm proficient in!</p>
    </div>
